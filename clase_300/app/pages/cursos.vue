...
// variables reactivas (dice ref)
// si su valor cambia VUE actualiza la página
...
// se usa "reactive" para objetos o arrays.
...
<template>
    <div class="mx-auto max-w-7xl space-y-4">
        ...
        <div class="rounded-xl border border-course-line bg-course-surface p-4 shadow-lg backdrop-blur sm:p-6">
            ...
            <UAlert v-if="error" color="error" variant="soft"
                ...
                :title="error.statusMessage || 'Error al cargar los cursos'" icon="i-heroicons-exclamation-circle" />
    ...
    <!-- Modal Agregar Curso -->
    <BaseFormModal v-model:open="mostrarFormulario" title="Agregar un Curso"
        ...
        <form class="space-y-4" @submit.prevent="guardarCurso">
            ...
            <UFormField label="Nombre" name="nombre" :ui="modalFormFieldUi">
                <UInput v-model="formCurso.nombre" color="neutral" variant="outline" class="w-full" :ui="modalInputUi"
                    placeholder="Ej: 1° Básico" />
            </UFormField>

            <!-- nivel -->
            <UFormField label="Nivel" name="nivel" :ui="modalFormFieldUi">
                <UInput v-model="formCurso.nivel" color="neutral" variant="outline" class="w-full" :ui="modalInputUi"
                    placeholder="Ej: 1, 2, 3, ..." />
            </UFormField>

            <!-- año -->
            <UFormField label="Año" name="anio" :ui="modalFormFieldUi">
                <UInput v-model="formCurso.anio" color="neutral" variant="outline" class="w-full" :ui="modalInputUi"
                    placeholder="2026" />
            </UFormField>
